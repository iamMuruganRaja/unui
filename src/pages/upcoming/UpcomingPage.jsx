...
const UpcomingPage = () => {
    ...
    console.log("User", authData.userData);
        ...
        <SplashScreen>
            <div className={classes.main_container}>
                        ...
                        events.map((event) => (
                            <div className={classes.card_outer_container}>
                                <div className={classes.card_inner_container}>
                                    <div
                                        className={
                                            classes.card_details_horizontal
                                        }
                                    >
                                        {console.log({
                                            asset: getAsset(
                                ...
                                <div className={classes.card_footer}>
                                    ...
                                    {console.log(
                                        "Participants",event.uuid,
                                        event.event_participants                                   )}

                                    {event.event_participants
                                        .map((i) => i.user_uuid)
                                        .indexOf(authData.userData.uuid) ===
                                    -1 ? (
                                        <Link
                ...
                <div className={classes.highlights_container}>
                    <div className={classes.highlights_title}>
                        Recent Highlights
                    </div>
                    <div className={classes.highlight_carousel}>
                        <img
                            alt="icon"
                            src={cardIcon}
                            className={classes.highlight_img}
                        />
                        <img
                            alt="icon"
                            src={cardIcon}
