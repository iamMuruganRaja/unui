        ...
        <div className={classes.main_container}>
            ...
            <div className={classes.card_container}>
                <div className={classes.top_icon_container}>
                    <Link to={`/event?event_id=${eventDetails.uuid}`} className={classes.edit_btn}>
                ...
                <div className={classes.card_details_section}>
                    <div className={classes.card_details_horizontal}>
                        ...
                        <p className={classes.details_text}>
                            Date:{" "}
                            {dayjs(eventDetails?.start_time).format("DD-MM-YY")}
                            <br />
                            Time:{" "}
                            {dayjs(eventDetails?.start_time).format("hh:mm a")}
                ...
                <div className={classes.card_footer}>
                    ...
                    <a
                        ...
                        disabled={dayjs().isAfter(
                            dayjs(eventDetails?.start_time).subtract(
                                10,
                                "minutes"
                            )
                        )}
